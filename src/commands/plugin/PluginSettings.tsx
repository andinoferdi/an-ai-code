...
function ErrorsTabContent(t0: {
  ...
  const extraMarketplaceErrors = errors.filter((e: PluginError) => (e.type === "marketplace-not-found" || e.type === "marketplace-load-failed" || e.type === "marketplace-blocked-by-policy") && !failedMarketplaceNames.has("marketplace" in e ? e.marketplace : ""));
          ...
          setAppState((prev_0: AppState) => ({
            ...
            plugins: {
              ...
              installationStatus: {
                ...
                marketplaces: prev_0.plugins.installationStatus.marketplaces.filter((m_1: {
                  name: string;
                }) => m_1.name !== action.name)
              }
            }
          }));
      ...
      case "remove-installed-marketplace":
        {
          (async () => {
            ...
            try {
              ...
              clearAllCaches();
              setMarketplaceLoadFailures((prev: Array<{
                name: string;
                error: string;
              }>) => prev.filter((f: {
                name: string;
